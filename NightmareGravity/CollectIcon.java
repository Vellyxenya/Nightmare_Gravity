...
public class CollectIcon extends SpecialBuffs
{
    int baseX;
    int baseY;
    public static int n;
    ...
    GreenfootImage image = new GreenfootImage("CollectSpell.png");
    public static GreenfootImage image2 = new GreenfootImage("CollectSpell.png");
