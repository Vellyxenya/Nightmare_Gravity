...
/**
 * La partie protectrice inférieure du 8e boss
 */
public class VellocatusLow extends Boss8Stuff
{
    /**
    ...
    private void attack0()
    {
        if(getWorld()!= null && Boss8Stuff.attack == true)
        {
            ...
            if(VellocatusHigh.counter == frequency)
            {
                follow();
            }
        }
